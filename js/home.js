    ...
    readFile('data/articles.json', function(articles) {
        ...
        // --------------------- STEP 1 ---------------------
            // 1. FAITE EN SORTE DE POUVOIR INSTANCIER UN OBJET 'Article' A PARTIR DES DONNEES DE LA VARIABLE 'articles'
                ...
                // On va instancier l'objet 'article'  etparcourir  les composants de l'objet article en utilisant "for".

                for (let i = 0; i < articles.length ; i++) {
                var
                 article = new Article(articles[i].id, articles[i].title, articles[i].author, articles[i].publishedDate, articles[i].img, articles[i].content, articles[i].resumes, articles[i].tags);
                    };
            ...
            // 1.2 DEFINIR DES GETTER/SETTER POUR CHAQUE PROPRIETES DE LA CLASS Article
                ...
                class article {
                    ...
                    //Partie setter ci-dessous

                    constructor(id,titre,author,publishedDate,img,content,resume,tag) {
                    ...
                    //Maintenant on fait la partie getter 
